...
pub fn scanUnwindInfo(macho_file: *MachO, reverse_lookups: [][]u32) !void {
...
pub fn writeUnwindInfo(macho_file: *MachO, reverse_lookups: [][]u32) !void {
    ...
    for (macho_file.objects.items) |*object, object_id| {
        ...
        for (unwind_records) |record, record_id| {
            ...
            // TODO scan unwind records and create any missing GOT references
