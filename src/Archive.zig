...
fn readObject(self: *Archive, arch: std.Target.Cpu.Arch, file_name: []const u8, reader: anytype) !void {
    ...
    // TODO implement std.fs.File.clone() or at the very least std.os.dup();
    var new_file = try fs.cwd().openFile(file_name, .{});
    var object = Object{
